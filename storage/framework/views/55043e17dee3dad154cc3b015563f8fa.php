...
<input name="name" value="<?php echo e($viewData['product']->getName()); ?>" type="text" class="form-control">
</div>
</div>
</div>
<div class="col">
...
<div class="col-lg-10 col-md-6 col-sm-12">
<input name="price" value="<?php echo e($viewData['product']->getPrice()); ?>" type="number" class="form-control">
</div>
</div>
</div>
</div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\OneDrive\Desktop\Install-Laravel\first-app\example-app\resources\views/admin/product/edit.blade.php ENDPATH**/ ?>